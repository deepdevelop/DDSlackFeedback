#
#  Be sure to run `pod spec lint DDSlackFeedback.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/deepdevelop/DDSlackFeedback"
  ...
  # s.social_media_url   = "http://twitter.com/Liu Yi"
  ...
  s.source       = { :git => "https://github.com/deepdevelop/DDSlackFeedback.git", :tag => "1.0" }
